								...
								<el-row :gutter="0">
									<el-col :md="this.adaptiveGrid.md" :lg="this.adaptiveGrid.lg">
										<el-form-item :label="this.isEditForm?'租赁点编号':'租赁点编号：'">
											<el-input v-if="this.isEditForm" v-model="form.orgCode" @keyup.enter.native="editContent('form_base')"
									...
									<el-col :md="this.adaptiveGrid.md" :lg="this.adaptiveGrid.lg">
										<el-form-item ref='orgName' :label="this.isEditForm?'租赁点名称':'租赁点名称：'" prop="orgName">
											<el-input v-if="this.isEditForm" @change='checkName' v-model="form.orgName" @keyup.enter.native="editContent('form_base')"
											          :disabled="disabled" clearable placeholder="请输入租赁点名称"></el-input>
											<span v-else>{{form.orgName}}</span>
										</el-form-item>
									</el-col>
									<el-col :md="this.adaptiveGrid.md" :lg="this.adaptiveGrid.lg">
										<el-form-item :label="this.isEditForm?'租赁点类型':'租赁点类型：'" prop="orgType">
											<el-select v-if="this.isEditForm" v-model="form.orgType" @keyup.enter.native="editContent('form_base')"
											    placeholder="请选择租赁点类型" clearable style="width:100%;">
												<el-option v-for="item in rentalListOptions" :key="item.orgId"
                                    ...
                                    <el-col :md="this.adaptiveGrid.md" :lg="this.adaptiveGrid.lg">
										<el-form-item :label="this.isEditForm?'建筑面积(m²)':'建筑面积(m²)：'" prop="buildArea">
											<el-input v-if="this.isEditForm" v-model="form.buildArea" oninput="value=value.replace(/[^\d]/g,'')" @keyup.enter.native="editContent('form_base')"
									...
									<el-col :md="24" :lg="24" style="height: auto;">
										<el-form-item :label="this.isEditForm?'机构图片':'机构图片：'">
											<el-row v-if="!this.isEditForm" class="agencyImageRow">
												<el-col class="agencyImageCol" :key="index" v-for="(item,index) in this.imageInfoVosLookUrl">
								...
								<el-row :gutter="0">
									<el-col :md="this.adaptiveGrid.md" :lg="this.adaptiveGrid.lg">
										<el-form-item :label="this.isEditForm?'服务商名称':'服务商名称:'" prop="spId">
											<el-select v-if="this.isEditForm" v-model="form.spId" filterable @keyup.enter.native="editContent('form_base')"
											           placeholder="请选择服务商名称" clearable style="width:100%;">
												<el-option v-for="item in serverListOptions" :key="item.dictValue"
												           :label="item.spName" :value="item.spId"></el-option>
											</el-select>
									...
									<el-col :md="this.adaptiveGrid.md" :lg="this.adaptiveGrid.lg">
										<el-form-item :label="this.isEditForm?'服务商联系人':'服务商联系人:'" prop="spLinkman">
											<el-input v-if="this.isEditForm" v-model="form.spLinkman" @keyup.enter.native="editContent('form_base')"
											          :disabled="disabled" clearable placeholder="请输入服务商联系人"></el-input>
											<span v-else>{{form.spLinkman}}</span>
										</el-form-item>
									</el-col>
									<el-col :md="this.adaptiveGrid.md" :lg="this.adaptiveGrid.lg">
										<el-form-item :label="this.isEditForm?'服务商联系人电话':'服务商联系人电话:'" prop="spPhone">
											<el-input v-if="this.isEditForm" v-model="form.spPhone" @keyup.enter.native="editContent('form_base')"
											          :disabled="disabled" clearable
											          placeholder="请输入服务商联系人电话"></el-input>
