		...
		<el-header class="formDiv">
			<el-form :inline="true" :model="form" class="demo-form-inline">
                <el-form-item label="所属区域">
					<Address :area-code="areaCode" :form-code="form.areaCode" @keyup.enter.native="onSubmit"
                ...
                <el-form-item  label="申请结果">
					<el-select v-model="form.applyResultType" placeholder="申请结果" clearable  @keyup.enter.native="onSubmit">
						<el-option label="申请成功" name="" value="1"></el-option>
						<el-option label="申请失败" name="" value="2"></el-option>
					</el-select>
				</el-form-item>
				<el-form-item  label="评估等级">
					<el-select v-model="form.assessLevel" placeholder="评估等级" clearable  @keyup.enter.native="onSubmit">
						<el-option :label="item.label" name="" :value="item.value" v-for="item in optionList" :key="item.value"></el-option>
					</el-select>
				</el-form-item>
				<el-form-item label="护理机构名称">
					<el-input v-model.trim="form.nurseOrgName" @keyup.enter.native="onSubmit" clearable placeholder="输入机构名称" style="width: 220px"
					></el-input>
				</el-form-item>
				<el-form-item label="关键词">
					<el-input v-model.trim="form.keyword" @keyup.enter.native="onSubmit" clearable placeholder="输入姓名或身份证查询" style="width: 220px"
					></el-input>
				</el-form-item>
				<el-form-item>
					...
					<el-button type="warning" @click="exportFun" class="base-btn" v-has="{class: '导出'}">导出
					</el-button>
				</el-form-item>
			</el-form>
		</el-header>
			...
			<el-container>
				...
				<el-main>
					...
					>
						...
						<el-table-column label="申请号" prop="applyNum" min-width="200"></el-table-column>
						<el-table-column label="申请日期" prop="applyDate" min-width="140"></el-table-column>
						...
						<el-table-column label="社保卡号" prop="socialCard" min-width="160"></el-table-column>
						<el-table-column label="评估类型" prop="assessType" min-width="100"></el-table-column>
						<el-table-column label="评估等级" prop="assessLevel" min-width="100"></el-table-column>
						<el-table-column label="申请结果" prop="applyResult" min-width="100"></el-table-column>
						<el-table-column label="护理类型" prop="nurseType" min-width="100"></el-table-column>
						<el-table-column label="护理机构" prop="nurseOrgName" min-width="160"></el-table-column>
