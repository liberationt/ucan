                  ...
                  <el-col :md="this.adaptiveGrid.md" :lg="this.adaptiveGrid.lg">
                    <el-form-item :label="this.isEditForm?'注册行政区划':'注册行政区划：'" prop="regArea">
                      <Address
                        ...
                        :id-edit="idEdit"
                        :area-code="regArea"
                        :form-code="form.regArea"
                        :width="'100%'"
                        :scope="'All'"
                        @keyup.enter.native="editContent('form_base')"
                        @getAreaCode="getAreaCode_reg_zhuce"
                      />
                  ...
                  <el-col :md="this.adaptiveGrid.md" :lg="this.adaptiveGrid.lg">
                    <el-form-item :label="this.isEditForm?'办公行政区划':'办公行政区划：'" prop="officeArea">
                      <Address
                        ...
                        :width="'100%'"
                        @keyup.enter.native="editContent('form_base')"
                        @getAreaCode="getAreaCode_reg_bangong"
                      />
                  ...
                  <el-col :md="this.adaptiveGrid.md" :lg="this.adaptiveGrid.lg">
                    <el-form-item :label="this.isEditForm?'运营方联系方式':'运营方联系方式：'" prop="opPhone">
                      <el-input
                        ...
                        @keyup.enter.native="editContent('form_base')"
                        @keyup.native="transformNumber(form.opPhone,'opPhone')"
                      />
                  ...
                  <el-col :md="this.adaptiveGrid.md" :lg="this.adaptiveGrid.lg">
                    <el-form-item :label="this.isEditForm?'机构负责人联系方式':'机构负责人联系方式：'" prop="orgHeadLinkman">
                      <el-input
                        v-if="this.isEditForm"
                        ref="orgHeadLinkman"
                        v-model="form.orgHeadLinkman"
                        :disabled="disabled"
                        clearable
                        placeholder="请输入机构负责人联系方式"
                        @keyup.enter.native="editContent('form_base')"
                      />
              ...
              >
                <el-row :gutter="0">
                  ...
                  <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    ...
                    <el-col :xs="22" :sm="22" :md="22" :lg="22" :xl="22">
                      <template v-if="this.isEditForm">
                        <el-col v-for="item in this.service_numOptions" :xs="24" :sm="12" :md="12" :lg="8" :xl="8">
                  ...
                  <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    ...
                    <el-col :xs="22" :sm="22" :md="22" :lg="22" :xl="22">
                      <template v-if="this.isEditForm">
                        <el-col v-for="item in this.workforce_typeOptions" :xs="24" :sm="12" :md="12" :lg="8" :xl="8">
                          <el-form-item :label="item.dictLabel" :prop="item.dictValue">
                            <el-input
...
export default {
  ...
  data() {
    ...
    // 校验--注册行政区划
    const verifyAreaCode_zhuce = (rule, value, callback) => {
    ...
    // 校验--办公行政区划
    const verifyAreaCode_bangong = (rule, value, callback) => {
    ...
    // 校验详细地址
    const verifyAddr_zhuce = (rule, value, callback) => {
      if (value.length === 0) {
    ...
    // 校验详细地址
    const verifyAddr_bangong = (rule, value, callback) => {
      if (value.length === 0) {
  ...
  methods: {
    ...
    getSelect() {
      return new Promise((resolve, reject) => {
        // 数据字典接口
        const dicKey = 'open_state,corp_attr_2,workforce_type,biz_build_main,service_num'
    ...
    toEditType() {
      ...
      this.$router.push({
        path: `/communityFacilities/healthService/${_id_}`,
