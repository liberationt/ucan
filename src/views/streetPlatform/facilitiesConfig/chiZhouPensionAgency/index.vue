      ...
      <el-container>
        ...
        <el-main>
          ...
          >
            ...
            <el-table-column label="开放状态" prop="openStateName" min-width="80" />
...
export default {
  ...
  methods: {
    ...
    toDetail(row) {
      this.$router.push({
        path: `/chiZhouPensionAgency/details/${row.orgId}`,
    ...
    jumpPensionAgency() {
      this.$router.push({
        path: `/chiZhouPensionAgency/details/0`,
        query: { 'modelType': 'add', 'instituType': '1010_chizhou', '_title': `新增养老机构` } // modelType: 查看:look，编辑:edit，新增:add的类型
      })
    },
    importFun() {
