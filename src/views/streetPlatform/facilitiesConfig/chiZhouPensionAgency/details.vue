  ...
  <el-container>
    <el-main class="tableContainer">
      <el-tabs v-model="activeTabs">
        ...
        <!--服务信息tabs start-->
        <el-tab-pane label="服务信息" name="service" disabled>
          <el-collapse v-model="activeCollapse">
            <!--基本服务item start-->
            ...
            <el-collapse-item name="baseItem_5">
              ...
              >
                <el-row :gutter="0">
                  <el-col :md="this.adaptiveGrid.md" :lg="this.adaptiveGrid.lg">
                    <el-form-item :label="this.isEditForm?'购买责任险人数（人）':'购买责任险人数（人）：'" prop="buyLiabilityNumber">
                      <el-input
                        v-if="this.isEditForm"
                  ...
                  <el-col :md="this.adaptiveGrid.md" :lg="this.adaptiveGrid.lg">
                    <el-form-item :label="this.isEditForm?'购买住院护理险人数（人）':'购买住院护理险人数（人）：'" prop="buyNursingNumber">
                      <el-input
                        v-if="this.isEditForm"
        ...
        <!--扩展信息tabs start-->
        <el-tab-pane label="扩展信息" name="extension" disabled>
          <el-collapse v-model="activeCollapse">
            <!--床位信息item start-->
...
export default {
  ...
  data() {
    ...
    return {
      ...
      form: {
        ...
        deanFullName: '', // 院长
        // ------拓展服务------
        buyLiabilityNumber: null, // 购买责任险人数（人）
        buyNursingNumber: null, // 购买住院护理险人数（人）
  ...
  methods: {
    ...
    closeDetailsPage() {
      ...
      this.$router.push({ path: '/streetPlatform/facilitiesConfig/chiZhouPensionAgency' })
    },
    //下一步校验
    checkRules(formName){
      //校验
    ...
    toEditType() {
      ...
      this.$router.push({
        path: `/chiZhouPensionAgency/details/${_id_}`,
