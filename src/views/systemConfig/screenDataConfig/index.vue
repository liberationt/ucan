			...
			<el-container>
				...
				<el-main>
					...
					>
						...
						<el-table-column label="在大屏中的位置描述信息" :show-overflow-tooltip="true" prop="position" width="200"></el-table-column>

						<el-table-column label="接口+参数信息" :show-overflow-tooltip="true" prop="key" min-width="200"></el-table-column>

						<el-table-column label="返回值信息" :show-overflow-tooltip="true" prop="value" min-width="300"></el-table-column>
              ...
              <template slot-scope="{row,$index}">
                <span>{{row.isValid === '0' ? '启用' : '禁用' }}</span>
						...
						<el-table-column fixed="right" label="操作" min-width="200" header-align="center"
						                 align="center">
							<template slot-scope="{row,$index}">
                <span @click="handleDisable($index, row)" class="table-btn">{{row.isValid === '0' ? '禁用' : '启用'}}</span>
                <span @click="handleEdit($index, row)" class="table-btn">编辑</span>
                <span @click="handleRemove($index, row)" class="table-btn">删除</span>
							</template>
						</el-table-column>
					</el-table>
